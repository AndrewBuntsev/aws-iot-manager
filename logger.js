...
const logger = winston.createLogger({
    ...
    transports: [
        new winston.transports.DailyRotateFile({ filename: `.\\logs\\error__%DATE%.log`, datePattern: 'YYYY-MM-DD', level: 'warn', handleExceptions: true }),
        new winston.transports.DailyRotateFile({ filename: `.\\logs\\info__%DATE%.log`, datePattern: 'YYYY-MM-DD', level: 'important', handleExceptions: true }),
        new winston.transports.DailyRotateFile({
            filename: `.\\logs\\trace__%DATE%.log`,
...
//don't display logging in console
// logger.add(
